...
public class PlayerBoardV1_8_R3 extends BPlayerBoard {
	private EntityPlayer playerHandle;
	private Field playerScoreField;

	public PlayerBoardV1_8_R3(INetheriteBoard netheriteBoard, Player player, String name) throws Exception {
		this(netheriteBoard, player, null, name);
	}

	public PlayerBoardV1_8_R3(INetheriteBoard netheriteBoard, Player player, Scoreboard scoreboard, String name) throws Exception {
		super(netheriteBoard, player, scoreboard, name);
		playerHandle = ((CraftPlayer) player).getHandle();

		playerScoreField = net.minecraft.server.v1_8_R3.Scoreboard.class.getDeclaredField("playerScores");
