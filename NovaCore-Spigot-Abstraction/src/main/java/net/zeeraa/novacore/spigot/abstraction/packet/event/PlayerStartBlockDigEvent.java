...
/**
 * This event is called when a player starts digging a block
 *
 * @author Bruno
 */
public class PlayerStartBlockDigEvent extends PlayerDigBlockEvent {
    ...
    public PlayerStartBlockDigEvent(Player player, Block block, BlockFace blockFace) {
