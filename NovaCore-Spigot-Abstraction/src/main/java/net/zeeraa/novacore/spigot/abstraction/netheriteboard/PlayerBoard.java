...
public interface PlayerBoard<V, N, S> {
	...
	/**
	 * Sets a line with its name and its score. This will update the line if it
	...
	/**
	 * Sets all the lines of the scoreboard. This will clear all of the current
	 * board lines, then set all of the given lines, from top to down, by giving
	 * them each a score determined by {@code lines.length - index}.
	 *
	 ...
	 * you'll need to create another PlayerBoard if you want to create the
	 * scoreboard again.
	 */
	void delete();
